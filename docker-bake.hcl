...
target "hardened" {
    tags = ["docker.io/juergenzimmermann/chora:2026.4.1-hardened"]
    #dockerfile = "Dockerfile"
    #no-cache = true
}

target "trixie" {
    tags = ["docker.io/juergenzimmermann/chora:2026.4.1-trixie"]
    dockerfile = "Dockerfile.trixie"
    #no-cache = true
}

target "alpine" {
    tags = ["docker.io/juergenzimmermann/chora:2026.4.1-alpine"]
